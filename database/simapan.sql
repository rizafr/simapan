...
-- Dumping data for table simapan.ref_klasifikasi: ~160 rows (approximately)
...
REPLACE INTO `surat_masuk` (`id_surat_masuk`, `kode_surat_masuk`, `no_surat_masuk`, `asal_surat_masuk`, `tgl_surat_masuk`, `status_surat_masuk`, `perihal_surat_masuk`, `tgl_penyelesaian`, `no_agenda`, `lampiran`, `tgl_diterima`, `pengolah`, `keterangan`, `status_disposisi`) VALUES
	...
	(3, 'KU.00', '282828/29292', 'walikota Cimahi', '2016-06-12', 'Penting', 'Peninjauan', '0000-00-00', '0003', 'no-photo-333.jpg', '2016-06-12', 1, 'laksanakan', 1),
	(4, 'KU.00', '2282828', 'Walikota', '2016-06-13', 'Biasa', 'Instruksi', '0000-00-00', '0004', 'Aplikasi_SI_MAPAN.docx', '2016-06-12', 1, '-', 1);
