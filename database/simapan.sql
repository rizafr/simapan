...
--
-- Host: 127.0.0.1    Database: simapan
-- ------------------------------------------------------
...
INSERT INTO `disposisi` (`id_disposisi`, `id_surat_masuk`, `isi_instruksi`, `tgl_instruksi`, `batas_waktu`, `waktu_lama_instruksi`, `paraf_kasi`, `paraf_kajari`, `tujuan_disposisi`, `tgl_disposisi`, `catatan`) VALUES (1,0,'','0000-00-00','0000-00-00',0,'','','','0000-00-00',''),(2,1,'Laksanakan\r\n','2015-07-30','2015-07-29',3,'','1','Kasi Pidum','2015-07-30','Laksanakan'),(3,1,'SIap 86','2015-07-30','2015-08-30',28,'1','1','Kajari','2015-07-30','Laksanakan'),(4,1,'tes','2015-08-01','2015-07-14',18,'1','1','Kasi Pidum','2015-08-01',''),(5,2,'Segera','2015-08-13','2016-08-17',369,'1','','Kasi Pidum','2015-08-13','-');
...
LOCK TABLES `jaksa` WRITE;
/*!40000 ALTER TABLE `jaksa` DISABLE KEYS */;
INSERT INTO `jaksa` (`id_jaksa`, `nip`, `nama_jaksa`) VALUES (1,'1992183193','Ratih'),(2,'1998193913','Riza');
...
INSERT INTO `level` (`id_level`, `level`) VALUES (1,'Super Admin'),(2,'Bagian Administrasi'),(3,'Seklur'),(4,'Kasi');
...
INSERT INTO `pengguna` (`id_pengguna`, `username`, `password`, `nama`, `nip`, `jabatan`, `id_level`) VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','Riza Fauzi Rahman','123456789123456','Administrator',1),(2,'ratih','a5bd72a3d2c4d1686415f93a46fc7a0a','Ratih Pujihati','123456789','Adminsitrator',1),(3,'seklur','faca25fa364201d24b323a91a6f6b463','Seklur','123456789123456','Seklur',3),(4,'kasipem','ec326e3752a6419e328ae0c2e910e1c0','Kasi Pem','123456789','Kasi Pem',4),(6,'staf','7b8a17c3f48d4453fde0fd74b4fa9212','Staf','123456789123456','Staf',2);
...
LOCK TABLES `perkara` WRITE;
/*!40000 ALTER TABLE `perkara` DISABLE KEYS */;
INSERT INTO `perkara` (`id_perkara`, `no_agenda`, `tanggal_perkara`, `nama_tersangka`, `perkara`, `id_jaksa`) VALUES (3,'0002','2015-08-13','Dikdik','Khasanah Dunia Pencopetan',1),(4,'0003','2007-02-08','Dikdik','Khasanah Dunia Pencopetan',0),(6,'001','2015-08-15','Muslihat saja','Preman Pensiun 2',2),(7,'002','2015-08-14','Dikdik','Khasanah Dunia Pencopetan',1),(8,'003','2015-08-21','Dikdik','Khasanah Dunia Pencopetan',1),(9,'004','2015-08-11','Muslihat saja','Preman Pensiun 3',1),(10,'005','2015-08-10','Dikdik','Khasanah Dunia Pencopetan',2),(11,'006','2015-08-11','Dikdik','Khasanah Dunia Pencopetan',1),(12,'007','2015-08-13','Muslihat saja','Preman Pensiun 4',1),(13,'008','2015-08-22','Dikdik','Khasanah Dunia Pencopetan',2),(14,'009','2015-08-12','Dikdik','Khasanah Dunia Pencopetan',1),(15,'010','2015-08-14','Muslihat saja','Preman Pensiun 5',1),(16,'011','2015-08-12','Dikdik','Khasanah Dunia Pencopetan',2),(17,'012','2015-08-11','Dikdik','Khasanah Dunia Pencopetan',1),(18,'013','2015-08-20','Muslihat saja','Preman Pensiun 6',2),(19,'014','2015-08-18','Dikdik','Khasanah Dunia Pencopetan',1),(20,'015','2015-08-10','Dikdik','Khasanah Dunia Pencopetan',1),(21,'016','2015-08-20','Muslihat saja','Preman Pensiun 7',2),(22,'017','2015-08-13','Dikdik','Khasanah Dunia Pencopetan',1),(23,'018','2015-08-19','Dikdik','Khasanah Dunia Pencopetan',2),(24,'019','2015-08-12','Muslihat saja','Preman Pensiun 8',1);
...
LOCK TABLES `posisi_penahanan` WRITE;
/*!40000 ALTER TABLE `posisi_penahanan` DISABLE KEYS */;
INSERT INTO `posisi_penahanan` (`id_posisi_penahanan`, `nama_posisi_penahanan`, `lama_posisi_penahanan`) VALUES (1,'Penyidik',20),(2,'Perpanjangan Tuntutan Hukum',40),(3,'Pengadilan',30),(4,'Penuntut Umum',20),(5,'Perpanjangan Pengadilan',40);
...
LOCK TABLES `posisi_perkara` WRITE;
/*!40000 ALTER TABLE `posisi_perkara` DISABLE KEYS */;
INSERT INTO `posisi_perkara` (`id_posisi_perkara`, `nama_posisi_perkara`) VALUES (1,'Pemberitahuan Mulainya Penyidikan (SPDP)'),(2,'Penelitian'),(3,'Pengecekan Berkas'),(4,'Pelimpahan Berkas Perkara'),(5,'Pembacaan Dakwaan'),(6,'Pemeriksaan Saksi'),(7,'Pemeriksaan Ahli'),(8,'Pemeriksaan Tersangka'),(9,'Pembacaan Tuntutan'),(10,'Putusan Pengadilan'),(11,'Upaya Hukum'),(12,'Eksekusi');
...
INSERT INTO `surat_masuk` (`id_surat_masuk`, `kode_surat_masuk`, `no_surat_masuk`, `asal_surat_masuk`, `tgl_surat_masuk`, `status_surat_masuk`, `perihal_surat_masuk`, `index_surat_masuk`, `no_agenda`, `lampiran`, `tgl_diterima`, `pengolah`, `keterangan`, `status_disposisi`) VALUES (1,'KU.02.2','kdkdkdk','Polisi Selawi','2015-07-31','Penting','Korupsi','DAERAH','0001','laptop.png','2015-07-30',1,'-',1),(2,'KU.00.1','1231','Polisi Selawi','2015-08-17','Rahasia','Khasanah dunia Pencopetan','DAERAH','0002','pin2.png','2015-07-30',1,'-',1),(3,'KU.00','282828/29292','walikota Cimahi','2016-06-12','Penting','Peninjauan','299','0003','no-photo-333.jpg','2016-06-12',1,'laksanakan',1);
...
INSERT INTO `t_admin` (`id`, `username`, `password`, `nama`, `nip`, `level`) VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','Riza Fauzi R','19900326 201401 1 002','Super Admin'),(2,'umum','a5bd72a3d2c4d1686415f93a46fc7a0a','Ratih Pujihati','19900326 201401 1 002','Super Admin'),(3,'admin1','e00cf25ad42683b3df678c61f42c6bda','Administrator 1','199003262017011001','Admin'),(4,'pidum','818767fe3d423ffeac7b8c03af827f3e','Kasi Pidum','123456','Pidum'),(5,'kajari','ec326e3752a6419e328ae0c2e910e1c0','Kajari','123456','Kajari');
/*!40000 ALTER TABLE `t_admin` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_aplikasi`
--

DROP TABLE IF EXISTS `t_aplikasi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_aplikasi` (
...
--
-- Dumping data for table `t_aplikasi`
--

LOCK TABLES `t_aplikasi` WRITE;
/*!40000 ALTER TABLE `t_aplikasi` DISABLE KEYS */;
INSERT INTO `t_aplikasi` (`id`, `name`, `desc`, `projectName`, `developedBy`) VALUES (1,'.:: SI MAPAN ::.','.:: SI MAPAN (Siapa Mengerjakan Apa, dimana, kapan) ::.','Proyek Perubahan Diklatpim V - Agus Irwan Kustiawan','Developed by Riza Fauzi Rahman');
...
INSERT INTO `t_disposisi` (`id`, `id_surat`, `kpd_yth`, `isi_disposisi`, `sifat`, `batas_waktu`, `catatan`) VALUES (1,1,'Kepala TU','ditindaklanjuti','Perhatian Batas Waktu','2015-05-27','');
...
INSERT INTO `t_surat_keluar` (`id`, `kode`, `no_agenda`, `isi_ringkas`, `tujuan`, `no_surat`, `tgl_surat`, `tgl_catat`, `keterangan`, `file`, `pengolah`) VALUES (1,'HM','0002','Permintaan data masjid bersejarah di Kota Yogyakarta','Kantor Kemenag Kota Yogyakartas','800/1221','2015-05-02','2015-05-24','','',1);
...
INSERT INTO `t_surat_masuk` (`id`, `kode`, `no_agenda`, `indek_berkas`, `isi_ringkas`, `dari`, `no_surat`, `tgl_surat`, `tgl_diterima`, `keterangan`, `file`, `pengolah`) VALUES (1,'','1','','','','','0000-00-00','2015-05-24','','Tes_Upload_file1.docx',1),(2,'','0002','','','','','0000-00-00','2015-07-30','','',1),(3,'','0002','','','','','0000-00-00','2015-07-30','','',1),(4,'','0002','','','','','0000-00-00','2015-07-30','','',1);
...
INSERT INTO `tr_instansi` (`id`, `nama`, `alamat`, `kepsek`, `nip_kepsek`, `logo`) VALUES (1,'Kelurahan Leuwigajah','Jalan Cimahi','Rully','199003262016011001','logo2.jpg');
...
-- Dump completed on 2016-06-12 11:25:10
