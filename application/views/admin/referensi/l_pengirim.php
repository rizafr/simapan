			...
			<div class="navbar navbar-inverse animated ">
				<div class="container">
					<div class="navbar-header">
						<a class="navbar-brand" href="#">Data Pengirim Surat </a>
					</div>
					<div class="navbar-collapse collapse navbar-inverse-collapse" style="margin-right: -20px">
						<ul class="nav navbar-nav">
							<li>
								<a href="<?php echo base_URL(); ?>referensi/pengirim/add" class="btn-info"><i
					...
					foreach ($data as $b) {
						...
						<tr>
							...
							if ($this->session->userdata('admin_level') == "Super Admin") {
								...
								<td class="ctr">
									<div class="btn-group">
										<a href="<?php echo base_URL(); ?>referensi/pengirim/edt/<?php echo $b->id_pengirim; ?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
										<a href="<?php echo base_URL() ?>referensi/pengirim/del/<?php echo $b->id_pengirim ?>"
