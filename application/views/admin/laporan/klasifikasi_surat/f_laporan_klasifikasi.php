...
<!-- /.navbar -->
<div class="well">
	<form action="<?php echo base_URL(); ?>laporan/klasifikasi_surat_cetak" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<input type="hidden" name="tipe" value="<?php echo $this->uri->segment(2); ?>">
		<table class="table-form" width="100%">
			<tr>
				<td width="20%">Klasifikasi Surat</td>
				<td>
					<b><input type="text" name="kode_surat_masuk" tabindex="6" id="kode_surat_masuk" value="" style="width: 100px" class="form-control" required></b>
				</td>
			</tr>
			<tr>
