...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <head>
		<title>.:: SI MAPAN (Siapa Mengerjakan Apa, dimana, kapan) ::.</title>
	...
	<body>
		...
		<div class="footer">
			<h4 style="font-weight: bold">Proyek Perubahan Diklatpim V- Agus Anwar </h4>
			<span> Developed Riza Fauzi Rahman</span>
