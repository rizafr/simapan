...
<div class="well">
<form action="<?php echo base_URL(); ?>agenda/surat_cetak" target="blank" method="post" accept-charset="utf-8" enctype="multipart/form-data">	
            ...
            <div class="col-lg-12">
                <div class="right mt25">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="icon icon-print icon-white"></i> Cetak
                        </button>
                </div>
            </div>
        </div>
