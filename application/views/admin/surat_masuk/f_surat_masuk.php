...
if ($mode == "edt" || $mode == "act_edt") {
	...
	$act				= "act_add";
	$id_surat_masuk		= "";
	$tgl_diterima		= tgl_jam_sql(date('Y-m-d'));
		...
		<div class="col-lg-6">
			<table  class="table-form">
				<tr>
					...
					<td>
						<b><input type="text" name="no_agenda" autofocus tabindex="1" readonly value="<?php echo $no_agenda; ?>" style="width: 100px" class="form-control"></b>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<b>
							...
							<tr>
								...
								<td>
									<b><input type="text" name="no_surat_masuk" tabindex="4" required value="<?php echo $no_surat_masuk; ?>"  id="no_surat_masuk" style="width: 300px" class="form-control"></b>
								</td>
							</tr>	
							<tr>
								<td width="20%">Perihal</td>
								<td>
									<b><textarea name="perihal_surat_masuk" tabindex="5" required style="width: 400px; height: 90px" class="form-control"><?php echo $perihal_surat_masuk; ?></textarea></b>
								</td>
							</tr>	
							<tr>
								<td colspan="2">
									...
									<button type="submit" class="btn btn-primary"tabindex="10" ><i class="icon icon-ok icon-white"></i> Simpan</button>
								</td>
							</tr>
						</table>
					</div>
					...
					<div class="col-lg-6">	
						...
						<tr>
							...
							<td>
								<b>
									<input type="file" name="lampiran" tabindex="9" class="form-control" style="width: 200px"></b>
									<br />
									<?php
									if ($lampiran) {
							...
							<tr>
								...
								<td>
									<b><input type="text" name="keterangan" value="<?php echo $keterangan; ?>" tabindex="10" style="width: 400px" class="form-control"></b>
								</td>
							</tr>	
						</table>	
					</div>
