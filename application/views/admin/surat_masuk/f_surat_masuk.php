		...
		<div class="col-lg-6">
			...
			<div class="col-lg-6">	
				<table class="table-form">
					...
					<tr>
						<td width="20%">Indeks Surat</td><td><b><input type="text" name="index_surat_masuk" tabindex="7" value="<?php echo $index_surat_masuk; ?>" style="width: 300px" class="form-control"></b>
					</td>
				</tr>
				<tr>
